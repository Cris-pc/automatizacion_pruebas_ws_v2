...
public class ReportUtil_12 {
    ...
    public static void generateCucumberReport(String karateOutputPath) {
        try {
            ...
            Configuration config = new Configuration(new File("/home/automatizacion/provisionamiento_hw_reactivacion_masivo_EN"), "Cucumber Reports");
