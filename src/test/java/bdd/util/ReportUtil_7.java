...
public class ReportUtil_7 {
    ...
    public static void generateCucumberReport(String karateOutputPath) {
        try {
            ...
            Configuration config = new Configuration(new File("/home/automatizacion/provisionamiento_zte_reactivacion_masivo_EN"), "Cucumber Reports");
