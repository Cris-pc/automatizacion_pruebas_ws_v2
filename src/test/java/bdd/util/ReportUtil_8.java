...
public class ReportUtil_8 {
    ...
    public static void generateCucumberReport(String karateOutputPath) {
        try {
            ...
            Configuration config = new Configuration(new File("/home/automatizacion/provisionamiento_zte_reactivacion_masivo_md"), "Cucumber Reports");
