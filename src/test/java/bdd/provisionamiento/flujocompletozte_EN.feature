Feature: Certificar provisionamiento zte en cliente ecuanet
  ...
  Background:flujocompletohw.feature
    ...
    * def tiempo_espera =
		...
		"""
  @name=flujozteec
  Scenario Outline: Flujo ZTE (activacion - cambio de plan - cortar - reactivar - cancelar) en empresa MD
    * print "****************************INICIA ACTIVACION FLUJO ZTE A ZTE ECUANET ***********************************"
    ...
    """
     {
        ...
        "vlan": "301",   "estado_servicio": "Activo",  "mac_wifi": "",
        "tipo_negocio_actual": "HOME",    "line_profile_nuevo": "",  "gemport_nuevo": "1",
        "traffic_table_nueva": "",  "tipo_negocio_nuevo": "HOME",   "vlan_nueva": "301",
        "ip": "",  "scope": "",   "ip_fijas_activas": 0,
        "capacidad_up": "<CAPACIDAD_UP>",    "capacidad_down": "<CAPACIDAD_DOWN>",
        "capacidad_up_nueva": "200000",   "capacidad_down_nueva": "200000"
       },
  ...
  "datos": {
    ...
    "ip_olt": "<IP_OLT>",    "puerto_olt": "<PUERTO_OLT>",    "modelo_olt": "<MODELO_OLT>",
    "gemport": "",    "service_profile": "<SERVICE_PROFILE>",    "line_profile": "",
    "traffic_table": "",    "vlan": "",    "estado_servicio": "Asignada",
    "ip": "",    "ip_fijas_activas": 0,    "tipo_negocio_actual": "HOME",
    "mac_wifi": "",    "scope": "",    "capacidad_up": "<CAPACIDAD_UP>",
    "capacidad_down": "<CAPACIDAD_DOWN>",    "equipoOntDualBand": "NO",
    "tipoOrden": "NUEVO",    "ont_id": "#(ontid)",
    "service_port": "#(spid)",    "ip_cancelar": []
  },
  ...
  "ipCreacion": "172.24.15.71",  "comandoConfiguracion": "SI",  "empresa": "EN"
    ...
    * print response
    ...
    Then status 200
      ...
      | ABAD ABAD JOSELYN CRISTINA | en-macjcabada1      | 0706575552        | 5A544547D164D265 | 20:65:8E:69:6F:9B   | olt-zte-8-labuio-uio  |  10.221.18.61     |  3/16      |    C610    |ZTEG-F670L      |30000       | 30000         | NO             |
