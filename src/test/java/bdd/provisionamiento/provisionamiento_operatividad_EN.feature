Feature: Certificar interoperatividad ont HW a olt ZTE en empresa ECUANET
  ...
  Background:flujocompletohw.feature
    ...
    * def tiempo_espera =
		...
		"""
  @name=flujoztehwEN
  Scenario Outline: Flujo HW a ZTE (activacion - cambio de plan - cortar - reactivar - cancelar) en empresa EN
    ...
    """
     ...
     "datos": {     "serial_ont": "<SERIALONT>",    "mac_ont": "<MACONT>",    "nombre_olt": "<NOM_OLT>",
       ...
       "gemport": "",    "service_profile": "<SERVICE_PROFILE>",    "line_profile": "",
        "traffic_table": "",   "ont_id": "#(ontid)",   "service_port": "#(spid)",
        "vlan": "301",   "estado_servicio": "Activo",    "mac_wifi": "",    "tipo_negocio_actual": "HOME",
        "line_profile_nuevo": "",  "gemport_nuevo": "1",   "traffic_table_nueva": "",
        "tipo_negocio_nuevo": "HOME",    "vlan_nueva": "301",  "ip": "",
       "scope": "",     "ip_fijas_activas": 0,   "capacidad_up": "<CAPACIDAD_UP>",
       "capacidad_down": "<CAPACIDAD_DOWN>",    "capacidad_up_nueva": "200000",
       "capacidad_down_nueva": "200000"      },       "opcion": "CAMBIAR_PLAN",     "ejecutaComando": "<EJECUTACOMANDO>",
        "usrCreacion": "TESTE2E",      "ipCreacion": "172.24.15.71",       "comandoConfiguracion": "SI",       "empresa": "EN"
       }
    """
    And call tiempo_espera 5
    * configure connectTimeout = 150000
    * configure readTimeout = 150000
    When method post
    * print response
  ...
  "empresa": "EN" }
    ...
    * print "******************************** ESCENARIO DE REACTIVACION *********************************************"
    ...
    {
  "nombre_cliente": "<NOM_CLIENTE>",  "login": "<LOGIN>",  "identificacion": "<IDENTIFICACION>",
  "datos": {    "ont_id": "#(ontid)",    "service_port": "#(spid)",    "serial_ont": "<SERIALONT>",
    ...
    "vlan": "",    "estado_servicio": "In-Corte",    "mac_wifi": null,
    "capacidad_up": "<CAPACIDAD_UP>",    "capacidad_down": "<CAPACIDAD_DOWN>",    "tipo_negocio_actual": "HOME",
    "ip_fijas_activas": 0  },  "opcion": "REACTIVAR",  "ejecutaComando": "<EJECUTACOMANDO>",
    "usrCreacion": "cguerra",  "ipCreacion": "172.24.15.71",  "comandoConfiguracion": "SI",  "empresa": "EN"
    }
    """
    And call tiempo_espera 10
    * configure connectTimeout = 150000
  ...
  "datos": {    "serial_ont": "<SERIALONT>",    "mac_ont": "<MACONT>",    "nombre_olt":  "<NOM_OLT>",
    "ip_olt": "<IP_OLT>",    "puerto_olt": "<PUERTO_OLT>",    "modelo_olt": "<MODELO_OLT>",
    "gemport": "",    "service_profile": "<SERVICE_PROFILE>",    "line_profile": "",    "traffic_table": "",
    "vlan": "",    "estado_servicio": "Asignada",    "ip": "",    "ip_fijas_activas": 0,
    "tipo_negocio_actual": "HOME",    "mac_wifi": "",    "scope": "",    "capacidad_up": "<CAPACIDAD_UP>",
    "capacidad_down": "<CAPACIDAD_DOWN>",    "equipoOntDualBand": "NO",  "tipoOrden": "NUEVO",    "ont_id": "#(ontid)",
    "service_port": "#(spid)",    "ip_cancelar": []  },  "opcion": "CANCELAR",  "ejecutaComando": "<EJECUTACOMANDO>",
  "usrCreacion": "cguerra",  "ipCreacion": "172.24.15.71",  "comandoConfiguracion": "SI",
  "empresa": "EN"
  }
    """
    When method post
    * print response
    ...
    Examples:
      ...
      | ABAD ABAD JOSELYN CRISTINA | en-macjcabada1      | 0706575552        | 48575443089A2A9F | 20:65:8E:69:6F:9B   | olt-zte-8-labuio-uio  |  10.221.18.61     |  3/16      |    C610     |EG8M8145V5G06  |30000        | 30000          | NO            |
